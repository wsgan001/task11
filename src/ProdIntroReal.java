...
public class ProdIntroReal {
        ...
        public ProdIntroReal(String str) {
            ...
            if (params.length == 9) {
                setRevenue(Double.parseDouble(params[8]));
            } else {
                setRevenue(0);
            }
        }

        public ProdIntroReal() {
        }

        public ProdIntroReal(ProdIntroReal from) {
            this.type = from.type;
         ...
         * @param list
         */
        public static void resetMinMax(List<ProdIntroReal> list) {
